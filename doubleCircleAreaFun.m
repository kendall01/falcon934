...
OUTER_RING_HOLES = 17; %num holes making up the outer ring of holes
INNER_RING_HOLES = 10; %num holes making up the inner ring of holes
RING_DIA = 3/32 * IN_TO_M; %initial diameter of all holes in ring, in meters
CENTER_DIA = 16/32 * IN_TO_M; % Diameter of the hole in the center
